...
from ssd_training import MultiboxLoss, Generator
from ssd import SSD300
from utils import BBoxUtility, ModelCheckpoint
...
if __name__ == "__main__":
    ...
    model.load_weights('../input/facemask-detection/model/ssd_weights.h5', by_name=True, skip_mismatch=True)
    # 训练参数设置
